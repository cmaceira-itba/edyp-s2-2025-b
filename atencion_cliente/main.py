...
class ReporteHorario:
    ...
    def __init__(self, hora_inicio, hora_fin, llamadas_atendidas,
    tiempo_promedio_espera, operador_destacado):
        ...
        pass
    def __str__(self):
        return (f"Reporte {self.hora_inicio}-{self.hora_fin}: "
...
class SistemaAtencionCliente:
    ...
    def llamadas_en_espera(self):
        ...
        # TODO: Implementar
        pass
    def generar_reporte(self, hora_inicio, hora_fin, llamadas_atendidas,
    tiempo_promedio, operador_destacado):
        """
        ...
        reporte = ReporteHorario(hora_inicio, hora_fin, llamadas_atendidas,
        tiempo_promedio, operador_destacado)
